...
coupling_maps = {'ibmq_qasm_simulator': None,
 'ibmqx2': [[0, 1],[0, 2],[1, 0],[1, 2],[2, 0],[2, 1],[2, 3],  [2, 4],  [3, 2],  [3, 4],  [4, 2],  [4, 3]],
 'ibmq_16_melbourne': [[0, 1],  [0, 14],  [1, 0],  [1, 2],  [1, 13],  [2, 1],  [2, 3],  [2, 12],  [3, 2],  [3, 4],  [3, 11],  [4, 3],  [4, 5],  [4, 10],  [5, 4],  [5, 6],  [5, 9],  [6, 5],  [6, 8],  [7, 8],[8, 6], [8, 7], [8, 9],  [9, 5], [9, 8],  [9, 10],  [10, 4],  [10, 9],  [10, 11],  [11, 3],  [11, 10],  [11, 12],  [12, 2],  [12, 11],  [12, 13],  [13, 1],  [13, 12],  [13, 14],  [14, 0], [14, 13]],
 ...
 'ibmq_armonk': None,
 'ibmq_rome': [[0, 1], [1, 0], [1, 2], [2, 1], [2, 3], [3, 2], [3, 4], [4, 3]]}
...
n_qubits = 9 
n_samples = 1000
n_procs =  40# number of cores/processes to use
...
sampling_dict["backend"]= 'ibmq_16_melbourne'
...
#sampling_dict["circuit_sampler_kwargs"] = {"coupling":coupling_maps[sampling_dict["backend"]]}
